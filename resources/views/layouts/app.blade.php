...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Agendstagram - @yield('titulo')</title>
        @stack('styles')
    ...
    <body class="bg-gray-100"> {{-- //bg es el color de la vista--}}
             ...
             contenido vertical y horizontalmente a la izquierda--}}
                ...
                @auth
                    <nav class="flex gap-2 items-center ">
                        ...
                        <a class="font-bold text-gray-700 text-sm"
                        ...
                        <form method="POST" action="{{ route('logout')}}">
                            @csrf
                            <button type="submit" class="font-bold uppercase text-gray-700 text-sm" >
                                Cerrar Sesión
                            </button>
                ...
                @guest
                    <nav class="flex gap-2 items-center ">
                        <a href="{{ route('login') }}" class="font-bold uppercase text-gray-700 text-sm" >
                            Login
                        </a>
                        {{--<a class="font-bold uppercase text-gray-700 text-sm" href="/sistemas/public/register">--}}
        ...
        <footer class="mt-10 text-center p-5 text-gray-500 font-bold uppercase">
            Agendstagram - Todos los derechos reservados
            {{now()->year}}
        </footer>
        {{-- @livewireScripts() --}}
    </body>
